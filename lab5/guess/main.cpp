...
/* CUDA:
nvcc -c guessing_cuda.cu -o guessing_cuda.o -O2 -DCUDA_PARALLEL
g++ -c main.cpp guessing.cpp PCFG.cpp train.cpp -O2
nvcc main.o guessing.o PCFG.o train.o guessing_cuda.o -o pcfg_cuda -O2
*/
